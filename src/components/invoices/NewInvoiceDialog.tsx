...
export const NewInvoiceDialog = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    if (items.length === 0) {
      form.setError("dealerId", { message: "Add at least one item" });
      return;
    }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Create a new invoice for a dealer</DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              {items.map((item, index) => (
                <div key={index} className="grid grid-cols-12 gap-2 items-end">
                  ...
                  <div className="col-span-2">
                    <Input type="number" placeholder="Total" value={item.total.toFixed(2)} readOnly disabled />
                  </div>
